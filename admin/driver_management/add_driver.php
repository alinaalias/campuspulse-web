...
<div class="card" style="max-width: 600px; margin: 0 auto;">
    ...
    <?php if ($success): ?>
        <div
            style="background:#d4edda; color:#155724; padding:12px; border-radius:6px; margin-bottom:20px; border-left:4px solid var(--success);">
    ...
    <form method="POST">
        ...
        <div style="margin-bottom:15px;">
            ...
            <input type="email" id="email" name="email" class="form-control" readonly
                style="background-color: #e9ecef; cursor: not-allowed; color: #666;" placeholder="@d.campuspulse.com">
            <small style="color:#888; font-size: 0.8rem;">* If this email exists, a number (e.g. 1, 2) will be added
                automatically.</small>
        </div>
