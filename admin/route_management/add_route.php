                ...
                <div class="card" style="max-width: 700px; margin: 0 auto;">
                    ...
                    <form method="POST">
                        <div style="margin-bottom:15px;">
                            ...
                            <input type="text" name="route_name" class="form-control" placeholder="e.g. Red Line Loop"
                                required>
                        </div>
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                            <div>
                                ...
                                <select name="zone_id" class="form-control" required
                                    onchange="filterStopsByZone(this.value)">
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px; margin-bottom: 20px;">
                            <div>
                                ...
                                <select id="startStopSelect" class="stop-select form-control"
                                    ...
                                    <?php foreach ($stops as $s):
                                        ...
                                        <option value="<?= $s['stop_id'] ?>"
                                            data-zones='<?= json_encode($s['zone_ids'] ?? []) ?>'
                            ...
                            <div>
                                ...
                                <select id="endStopSelect" class="stop-select form-control"
                        ...
                        <div
                            ...
                            <button type="button" class="btn"
                                style="background:var(--accent-yellow); color:#333; font-weight:600;"
