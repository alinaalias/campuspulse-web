...
<style>
    ...
    .admin-search-box {
        ...
        margin: 0 !important;
        /* Prevents global style interference */
    }
...
<div class="card" style="margin-bottom: 30px;">
    <div
        ...
        <h3 style="color:var(--primary-blue); margin:0;"><i class="fas fa-globe-asia" style="margin-right:8px;"></i>
            System Coverage Map</h3>
        <div id="mapLegend"
...
<div style="margin-bottom: 25px; display:flex; gap:10px;">
    <a href="#section-routes" class="btn" style="background:var(--primary-blue); color:white;"><i class="fas fa-route"
            style="margin-right: 5px;"></i> Routes</a>
...
<div id="section-stops" class="card" style="margin-top:40px;">
    <div
        ...
        <div class="header-actions-wrapper">
            <div class="admin-search-box">
                <i class="fas fa-search"></i>
                <input type="text" id="searchStops" placeholder="Search stops..." onkeyup="handleSearch('tableStops')">
            </div>
                    ...
                    <td>
                        <div class="action-flex">
                            ...
                            <a href="delete_stop.php?id=<?= $id ?>" class="btn-icon danger"
                                onclick="return confirm('Delete stop?')" title="Delete"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
            <?php endforeach; ?>
...
<div id="section-zones" class="card" style="margin-top:40px;">
    <div
        ...
        <div class="header-actions-wrapper">
            <div class="admin-search-box">
                <i class="fas fa-search"></i>
                <input type="text" id="searchZones" placeholder="Search zones..." onkeyup="handleSearch('tableZones')">
            </div>
        ...
        <tbody>
            <?php foreach ($zones as $id => $z): ?>
                <tr class="searchable-row">
                    ...
                    <td>
                        <div class="action-flex">
                            <a href="edit_zone.php?id=<?= $z['zone_id'] ?>" class="btn-icon" title="Edit"><i
                                    class="fas fa-edit"></i></a>
                            <a href="delete_zone.php?id=<?= $z['zone_id'] ?>" class="btn-icon danger"
                                onclick="return confirm('Delete zone?')" title="Delete"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
            <?php endforeach; ?>
