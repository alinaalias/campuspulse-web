...
<head>
    <meta charset="UTF-8">
    <title>Live Operations - CampusPulse</title>
...
<body>
            ...
            <div class="main-content">
                ...
                <div class="map-container">
                    <div class="layer-controls">
                        ...
                        <div class="toggle-row">Show All Stops <label class="switch"><input type="checkbox"
                                    id="toggleStops" checked onchange="updateLayers()"><span
                                    class="slider"></span></label></div>
                        <div class="toggle-row">Show Heatmaps <label class="switch"><input type="checkbox"
                                    id="toggleZones" checked onchange="updateLayers()"><span
                                    class="slider"></span></label></div>
                        <div class="toggle-row">Active Shuttles Only <label class="switch"><input type="checkbox"
                                    id="toggleActiveOnly" onchange="updateLayers()"><span class="slider"></span></label>
                        </div>
                    </div>
                    <div id="liveMap"></div>
                </div>
    ...
    <script>
        ...
        function initMap() {
            // UPDATED: Added mapId and removed local styles to support Advanced Markers
            ...
            Object.keys(zonePoints).forEach(zid => {
                ...
                if (points.length >= 3) {
                    ...
                    // UPDATED: Use Advanced Marker for Zone Labels
            ...
            stopsData.forEach(s => {
                ...
                // UPDATED: Use Advanced Marker for Stops
            ...
            db.collection('Shuttles').onSnapshot(snapshot => {
                snapshot.forEach(doc => {
                    ...
                    if (!fleetMarkers[id]) {
                        // UPDATED: Use Advanced Marker for Fleet Vehicles (Vans)
                        ...
                        fleetMarkers[id].isOnline = isOnline; // Custom property for layer toggling

                        // UPDATED: Use gmp-click event
                        fleetMarkers[id].addEventListener('gmp-click', () => {
                        ...
                        fleetMarkers[id].isOnline = isOnline; // Update custom property
                    }
        ...
        function updateLayers() {
            ...
            // UPDATED: Use .map = null for Advanced Markers, but keep setMap() for Polygons
