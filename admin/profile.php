        ...
        <div id="content">
            ...
            <div class="main-content">
                ...
                <div class="card" style="max-width: 850px; margin: 0 auto;">
                    <h2
                        style="color:var(--primary-blue); margin-bottom: 25px; border-bottom:1px solid #eee; padding-bottom:10px;">
                        Profile Settings
                    </h2>
                    ...
                    <form method="POST" enctype="multipart/form-data" style="display:flex; gap:40px; flex-wrap:wrap;">
                        ...
                        <div
                            style="flex:1; text-align:center; min-width:250px; border-right:1px solid #f0f0f0; padding-right:20px;">
                            <div style="position:relative; display:inline-block; margin-bottom:15px;">
                                <img src="<?= htmlspecialchars($admin['profile_pic'] ?? '../img/default-avatar.jpg') ?>"
                                    id="previewImg"
