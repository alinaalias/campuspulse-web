...
<head>
    ...
    <title>Review Application: <?= htmlspecialchars($applicationData['full_name'] ?? 'Unknown Name') ?> - Admin -
        CampusPulse</title>
                    ...
                    <div class="details-grid">
                        ...
                        <div class="detail-card">
                            ...
                            <div class="info-row">
                                ...
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['full_name'] ?? 'N/A') ?></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">IC Number:</span>
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['ic_number'] ?? 'N/A') ?></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">Gender:</span>
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['gender'] ?? 'N/A') ?></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">Date of Birth:</span>
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['dob'] ?? 'N/A') ?></span>
                            </div>
                            <div class="info-row">
                        ...
                        <div class="detail-card">
                            ...
                            <div class="info-row">
                                ...
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['phone_number'] ?? 'N/A') ?></span>
                            </div>
                        ...
                        <div class="detail-card">
                            ...
                            <div class="info-row">
                                ...
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['license_number'] ?? 'N/A') ?></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">License Expiry:</span>
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['license_expiry'] ?? 'N/A') ?></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">PSV Expiry:</span>
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['psv_expiry'] ?? 'N/A') ?></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">Years Experience:</span>
                                <span
                                    class="info-value"><?= htmlspecialchars($applicationData['years_experience'] ?? '0') ?>
                                    Years</span>
                            </div>
                        </div>
    ...
    <div id="rejectModal"
        ...
        <div
            ...
            <form action="process_application.php" method="POST">
                ...
                <textarea name="reject_reason_custom" id="customReason" rows="4"
